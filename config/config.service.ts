...
export const JWT_SECRET_ACCESS_USER = process.env
  .JWT_SECRET_ACCESS_USER as string;
export const JWT_SECRET_ACCESS_ADMIN = process.env
  .JWT_SECRET_ACCESS_ADMIN as string;
export const JWT_SECRET_REFRESH_USER = process.env
  .JWT_SECRET_REFRESH_USER as string;
export const JWT_SECRET_REFRESH_ADMIN = process.env
  .JWT_SECRET_REFRESH_ADMIN as string;
...
export const DEFAULT_SUPER_ADMIN_EMAIL = process.env
  .DEFAULT_SUPER_ADMIN_EMAIL as string;
export const DEFAULT_SUPER_ADMIN_PASSWORD = process.env
  .DEFAULT_SUPER_ADMIN_PASSWORD as string;
...
export const RATE_LIMIT_LOGIN_WINDOW = +(
  process.env.RATE_LIMIT_LOGIN_WINDOW || 15 * 60 * 1000
);

export const RATE_LIMIT_SIGNUP_MAX = +(process.env.RATE_LIMIT_SIGNUP_MAX || 3);
export const RATE_LIMIT_SIGNUP_WINDOW = +(
  process.env.RATE_LIMIT_SIGNUP_WINDOW || 60 * 60 * 1000
);

export const RATE_LIMIT_VERIFY_MAX = +(process.env.RATE_LIMIT_VERIFY_MAX || 5);
export const RATE_LIMIT_VERIFY_WINDOW = +(
  process.env.RATE_LIMIT_VERIFY_WINDOW || 15 * 60 * 1000
);

export const RATE_LIMIT_RESEND_MAX = +(process.env.RATE_LIMIT_RESEND_MAX || 3);
export const RATE_LIMIT_RESEND_WINDOW = +(
  process.env.RATE_LIMIT_RESEND_WINDOW || 15 * 60 * 1000
);

export const RATE_LIMIT_CONTACT_MAX = +(
  process.env.RATE_LIMIT_CONTACT_MAX || 5
);
export const RATE_LIMIT_CONTACT_WINDOW = +(
  process.env.RATE_LIMIT_CONTACT_WINDOW || 60 * 60 * 1000
);
